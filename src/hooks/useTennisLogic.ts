...
export function getNextPoint(current: string | number, opponent: string | number, useGoldenPoint: boolean = false): string {
...
export function checkSetWin(games1: number, games2: number, targetGames: number = 6): boolean {
  // Normal Set
